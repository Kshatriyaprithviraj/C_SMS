...
int CheckDate(int,int);// for checking date
void AddRecords(int);//for adding records
void ModifyRecords(int);//for modifying records
void SearchRecords(int);//for searching records
void DeleteRecords(int);//for deleting records
...
void main(void)
{
    ...
    printf("\t|    AUTHORED BY KSHATRIYA PRITHVI RAJ                    |\n");
